...
impl State {
    ...
    fn transfer_internal(
        ...
        // Self-transfer must not change the account balance.
        // It still increments the nonce for a normal transfer.
        let new_sender_balance = if from == to {
            sender_balance
        } else {
            sender_balance
                .checked_sub(amount)
